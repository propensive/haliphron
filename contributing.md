...
# Contributing to Haliphron

Firstly, thank you for taking an interesting in contributing! Haliphron is an open-source project, and welcomes
...
Haliphron is developed using [Fury](https://github.com/propensive/fury), which may be installed by running the
...
The simplest way to compile Haliphron is to run,
```
fury
```
...
It&rsquo;s a good idea to [discuss](https://riot.im/app/#/room/#propensive.haliphron:matrix.org) potential changes
...
If a response is not forthcoming in the [Riot chatroom](https://riot.im/app/#/room/#propensive.haliphron:matrix.org),
...
issue before work starts. If you have commit rights to the `propensive/haliphron` repository, please only push to
...
rejected on grounds of formatting, except in extreme cases. Haliphron does not use automatic code-formatting
...
development environment for all Haliphron&rsquo;s users. Propensive O&Uuml; reserves the right to censure
